...
function InvoiceStatus() {
  return (
    <PDFDocument title="Invoice" author="Me">
      <PDFPage>
        <PDFContainer className="flex-row gap-2 p-4">
          <PDFBadge variant="success" className="px-3 py-1 text-xs font-medium">Paid</PDFBadge>
          <PDFBadge variant="destructive" className="px-3 py-1 text-xs font-medium">Overdue</PDFBadge>
        </PDFContainer>
      </PDFPage>
    </PDFDocument>
  );
