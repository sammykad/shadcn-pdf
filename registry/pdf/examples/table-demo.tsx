...
export default function PDFTableDemo() {
  return (
    <PDFTable>
      <PDFTableHeader>
        <PDFTableHead flex={2} className="font-semibold text-muted">Invoice</PDFTableHead>
        <PDFTableHead flex={3} className="font-semibold text-muted">Client</PDFTableHead>
        <PDFTableHead flex={2} className="font-semibold text-muted">Amount</PDFTableHead>
        <PDFTableHead flex={2} className="font-semibold text-muted">Status</PDFTableHead>
      </PDFTableHeader>
      <PDFTableBody>
        {invoices.map((inv) => (
      ...
      <PDFTableFooter>
        <PDFTableCell flex={7}>
          <PDFText variant="small" className="text-xs text-muted">Total (3 invoices)</PDFText>
        </PDFTableCell>
        <PDFTableCell flex={2}>
